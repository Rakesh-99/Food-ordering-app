...
export const restaurantSchema = z.object({
    ...
    delivery_time: z.number().max(60, "Delivery time cannot exceed 60 minutes!").min(1, "Delivery time must be at least 1 minute!").min(0, "Delivery time can not be set to negetive time"),
